...
namespace GezenKitap.UI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, BirthDate = model.BirthDate, FirstName = model.FirstName, LastName = model.LastName, PhoneNumber = model.PhoneNumber, Credit = 30, CreatedDate = DateTime.Now };
        ...
        public ActionResult UpdateProfile()
        {
            ...
            ViewBag.Token = UserManager.GeneratePasswordResetToken(userId);
        ...
        public ActionResult UpdateProfile(ApplicationUser model)
        {
            try
            {
                ...
                {
                    if (model.Password != Request["ConfirmPassword"])
                        throw new Exception("Şifre eşlemiyor!");
            ...
            {
                ModelState.AddModelError("Error", "Bir hata oluştu!" + ex.Message);
            }
